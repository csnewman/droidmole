...
type EmulatorControllerClient interface {
	...
	SetPosture(ctx context.Context, in *Posture, opts ...grpc.CallOption) (*empty.Empty, error)
	...
	SetBrightness(ctx context.Context, in *BrightnessValue, opts ...grpc.CallOption) (*empty.Empty, error)
	// Returns the current mode of the primary display of a resizable AVD.
	// The following gRPC error codes can be returned:
	// -  FAILED_PRECONDITION (code 9) if the AVD is not resizable.
	GetDisplayMode(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*DisplayMode, error)
	// Sets the size of the primary display of a resizable AVD. Fails if the AVD is
	// not resizable.
	// The following gRPC error codes can be returned:
	// -  FAILED_PRECONDITION (code 9) if the AVD is not resizable.
	SetDisplayMode(ctx context.Context, in *DisplayMode, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *emulatorControllerClient) SetPosture(ctx context.Context, in *Posture, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/android.emulation.control.EmulatorController/setPosture", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emulatorControllerClient) GetBrightness(ctx context.Context, in *BrightnessValue, opts ...grpc.CallOption) (*BrightnessValue, error) {
	...
	err := c.cc.Invoke(ctx, "/android.emulation.control.EmulatorController/getBrightness", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emulatorControllerClient) SetBrightness(ctx context.Context, in *BrightnessValue, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/android.emulation.control.EmulatorController/setBrightness", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emulatorControllerClient) GetDisplayMode(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*DisplayMode, error) {
	out := new(DisplayMode)
	err := c.cc.Invoke(ctx, "/android.emulation.control.EmulatorController/getDisplayMode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emulatorControllerClient) SetDisplayMode(ctx context.Context, in *DisplayMode, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/android.emulation.control.EmulatorController/setDisplayMode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmulatorControllerServer interface {
	...
	// Set foldable posture
	SetPosture(context.Context, *Posture) (*empty.Empty, error)
	// Get the backlight brightness.
	// The following gRPC error codes can be returned:
	// -  FAILED_PRECONDITION (code 9) if the AVD does not support hw-control.
	...
	// -  FAILED_PRECONDITION (code 9) if the AVD does not support hw-control.
	// -  INVALID_ARGUMENT (code 3) The brightness exceeds the valid range.
	SetBrightness(context.Context, *BrightnessValue) (*empty.Empty, error)
	// Returns the current mode of the primary display of a resizable AVD.
	// The following gRPC error codes can be returned:
	// -  FAILED_PRECONDITION (code 9) if the AVD is not resizable.
	GetDisplayMode(context.Context, *empty.Empty) (*DisplayMode, error)
	// Sets the size of the primary display of a resizable AVD. Fails if the AVD is
	// not resizable.
	// The following gRPC error codes can be returned:
	// -  FAILED_PRECONDITION (code 9) if the AVD is not resizable.
	SetDisplayMode(context.Context, *DisplayMode) (*empty.Empty, error)
...
func (UnimplementedEmulatorControllerServer) SetPosture(context.Context, *Posture) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetPosture not implemented")
}
...
func (UnimplementedEmulatorControllerServer) SetBrightness(context.Context, *BrightnessValue) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetBrightness not implemented")
}
func (UnimplementedEmulatorControllerServer) GetDisplayMode(context.Context, *empty.Empty) (*DisplayMode, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDisplayMode not implemented")
}
func (UnimplementedEmulatorControllerServer) SetDisplayMode(context.Context, *DisplayMode) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetDisplayMode not implemented")
}
...
func _EmulatorController_SetPosture_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/android.emulation.control.EmulatorController/setPosture",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmulatorController_GetBrightness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/android.emulation.control.EmulatorController/getBrightness",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmulatorController_SetBrightness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/android.emulation.control.EmulatorController/setBrightness",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmulatorController_GetDisplayMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/android.emulation.control.EmulatorController/getDisplayMode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmulatorControllerServer).GetDisplayMode(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EmulatorController_SetDisplayMode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/android.emulation.control.EmulatorController/setDisplayMode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
